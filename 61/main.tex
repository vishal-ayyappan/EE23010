...
\solution\\
\textbf{t-statistic}:
It is a measure of how many standard errors a point estimate is away from the hypothesized value.\\
\textbf{Standard error}:
It is a measure of how much the estimator is likely to vary from the true value of the parameter it is estimating.\\ 
The t-statistic is derived by dividing the difference between the point estimate and the hypothesized value by the standard error of the estimator. It is given by,\\
\begin{align}
