...
\end{align*}
where $u\brak{.}$ is the standard unit step function. the probability of symbol error for this system is\\
\solution\\
...
\end{cases}
\end{align}
Probability of error when $x_{A}$ is transmitted:\\
When $x_{A}$ is transmitted, error occurs in $0<y<1$ because, in this interval the likelihood of observing $Y$ given $x_{A}$ is lower than the likelihood of observing $Y$ given $x_{B}$, Therefore,
\begin{align}
...
P_{e_{x_{A}}} &= 0.23
\end{align}
Probability of error when $x_{B}$ is transmitted:\\
When $x_{B}$ is transmitted, error occurs in $-1<y<0$ because, in this interval the likelihood of observing $Y$ given $x_{A}$ is higher than the likelihood of observing $Y$ given $x_{B}$, Therefore,
\begin{align}
...
P_{e_{x_{B}}} &= 0.23
\end{align}
Outside of these intervals, the ML detector can more reliably make a decision.\\
The probability of error can be given as 
\begin{align}
