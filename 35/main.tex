...
\hline
Random variable &Value &Definition &pmf  \\ \hline
\multirow{3}{*}{$X$} &0 &Box A &$\frac{1}{3}$  \\ 
 &1 &Box B &$\frac{2}{3}$  \\ 
 &2 &Box C &$1$  \\ \hline 
\multirow{3}{*}{$Y$} &0 &Slips of Rs 1 &$\frac{64}{75}$  \\ 
 &1 &Slips of Rs 5 &$\frac{6}{75}$ \\ 
 &2 &Slips of Rs 13 &$\frac{5}{75}$ \\ \hline 
\end{tabular}
\caption{Distribution}
\label{tab:Distribution}
\end{table}
\begin{align}
p_{XY}(20) &= p_{X}(0) \times p_{XY}(00) + p_{X}(1) \times p_{XY}(10)\\
p_{XY}(20) &= \frac{64}{75}
\end{align}
