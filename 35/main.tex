...
\end{align}
which is the probability of drawing Rs 1 in Box A.
\begin{align}
\Pr (Y=0|X=1 ) = \frac{6}{25}
\end{align}
which is the probability of drawing Rs 5 in Box A.
\begin{align}
\Pr (Y=1|X=0) = \frac{45}{50}
\end{align}
which is the probability of drawing Rs 1 in Box B.
\begin{align}
\Pr (Y=1|X=2) = \frac{5}{50}
\end{align}
which is the probability of drawing Rs 13 in Box B.\\
Probability that the slip is marked other than 1,
\begin{align}
&=p_{Y}(0) \times \Pr(Y=0 | X=1) + p_{Y}(1) \times \Pr (Y=1|X=2)\\
