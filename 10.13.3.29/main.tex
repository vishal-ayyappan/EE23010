...
Hence total number of club cards left
\begin{align}
13 - 3 = 10
\end{align}
Let $E_1$ = Event of getting a club
\begin{align}
E_1 = 10\\
P_r \brak{E_1} = \frac{10}{49}
\end{align}
\item 10 of Hearts\\
Let $E_2$ = Event of getting a 10 of hearts
\begin{align}
E_2 = 1\\
P_r \brak{E_2} = \frac{1}{49}
\end{align}
\end{enumerate}
