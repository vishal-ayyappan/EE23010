...
$X_1$ &49 &0 &the card is not a club & $\frac{39}{49}$\\ \hline
$X_2$ &49 &1 &the card is a 10 of hearts & $\frac{1}{49}$\\ \hline
$X_2$ &49 &0 &the card is a not a 10 of hearts & $\frac{48}{49}$\\ \hline
\end{tabular}
\end{table}
From the table,
\begin{enumerate}[label=(\roman*)]
\item The event of getting a club
\begin{align}
P_r \brak{X_1=1} = \frac{10}{49}
\end{align}
\item The event of getting a 10 of hearts
\begin{align}
P_r \brak{X_2=1} = \frac{1}{49}
\end{align}
\end{enumerate}
