...
\end{align}
The likelihood function represents the relative probability of observing samples at different values of $\theta$. So, the probability of observing the sample is the product of the probabilities of each observation.
\begin{align}
